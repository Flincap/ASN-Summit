...
const HeroSection: React.FC = () => {
      ...
      return (
        <div className="grid grid-cols-4 gap-2 md:gap-4 text-center">
          <div className="bg-white bg-opacity-90 rounded-lg p-2 md:p-4">
            <div className="text-2xl md:text-4xl font-bold text-primary-700">{days}</div>
            <div className="text-xs md:text-sm text-gray-600">Days</div>
          </div>
          <div className="bg-white bg-opacity-90 rounded-lg p-2 md:p-4">
            <div className="text-2xl md:text-4xl font-bold text-primary-700">{hours}</div>
            <div className="text-xs md:text-sm text-gray-600">Hours</div>
          </div>
          <div className="bg-white bg-opacity-90 rounded-lg p-2 md:p-4">
            <div className="text-2xl md:text-4xl font-bold text-primary-700">{minutes}</div>
            <div className="text-xs md:text-sm text-gray-600">Minutes</div>
          </div>
          <div className="bg-white bg-opacity-90 rounded-lg p-2 md:p-4">
            <div className="text-2xl md:text-4xl font-bold text-primary-700">{seconds}</div>
  ...
  return (
    <section className="relative min-h-screen flex items-center bg-hero-pattern bg-cover bg-center py-20">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="max-w-4xl">
          ...
          >
            ...
            <Button variant="outline" className="border-white text-white hover:bg-white hover:bg-opacity-10" href="mailto:nath@africastablecoin.org?subject=Sponsorship%20Deck%20Request">
