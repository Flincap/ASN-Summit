...
const BenefitCard: React.FC<BenefitCardProps> = ({
  ...
  return (
    <motion.div variants={cardVariants} className="flex space-x-4">
  ...
  const benefits = [
    {
      ...
      description:
        "Position your solution at the center of Africa's stablecoin future.",
    },
    {
      icon: <Radio size={20} />,
    ...
    },
    {
      ...
      description:
        "Meet customers and partners actively seeking new solutions.",
    },
    {
      icon: <Award size={20} />,
            ...
            <div className="bg-gray-50 p-8 rounded-xl shadow-custom h-full">
              ...
              <div className="space-y-5">
                <div className="border-l-4 border-secondary-500 pl-4">
                  <h4 className="font-bold text-lg text-dark-800 mb-1">
                    Diamond Partner
                  </h4>
                  <p className="text-dark-500">
                    Premium positioning and maximum visibility
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-500 pl-4">
                  ...
                  <p className="text-dark-500">
                    Enhanced presence and speaking opportunities
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-400 pl-4">
                  ...
                  <p className="text-dark-500">
                    Brand visibility and networking focus
                  </p>
                </div>
                ...
                <div className="border-l-4 border-primary-300 pl-4">
                  ...
                  <p className="text-dark-500">
                    Entry-level participation and basic visibility
                  </p>
                </div>

                <div className="mt-8 pt-6 border-t border-gray-200">
                  <p className="text-dark-500 italic">
                    Custom packages are available to meet your specific
