...
const ExhibitionSection: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Live Demos",
      description:
        "Interactive product demonstrations to engage potential clients",
    },
    {
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-3xl mx-auto text-center mb-12">
          <p className="text-lg text-dark-600">
            The Nigeria Stablecoin Summit exhibition floor is a hotspot for
            discovery, demo sessions, and direct B2B engagement with active
        ...
        >
          {features.map((feature, index) => (
            ...
            >
              ...
              <h3 className="text-xl font-heading font-bold mb-3 text-dark-800">
                {feature.title}
              </h3>
