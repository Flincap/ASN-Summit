        ...
        >
          <div className="text-center mb-8">
            <h3 className="text-2xl font-heading font-bold text-dark-800 mb-2">
              Nathaniel Ochuko Luz
            </h3>
            <p className="text-dark-500 font-medium">
              President, African Stablecoin Network
            </p>
            <p className="text-dark-500">Convener, Nigeria Stablecoin Summit</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              <p className="text-dark-600">
                For inquiries about sponsorships, speaking opportunities, or
                general event information, please don't hesitate to reach out.
              </p>
            </div>
          </div>
        </motion.div>
